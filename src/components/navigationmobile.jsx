    ...
    return (
      <Absolute onClick={() => this.closeMenu()}>
        <Bar>
          ...
          >
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.742373512">
              <g id="Cafe-Bar-Black---Mobile" transform="translate(-356.000000, -32.000000)" fill="#000000">
                <path
        ...
        <div className={'menu' + this.state.sidebarOpen} onClick={() => this.toggleMenu()}>
          <MobileContainer>
            <MobileList>
